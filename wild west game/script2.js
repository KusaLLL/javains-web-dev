...
function keycheck(event) {
  ...
  if (event.which == 13) {
    ...
    if (runWorkerId === 0) {
      ...
      // After updating the highScore variable
      var highScoreElement = document.getElementById("highScore");
      highScoreElement.innerHTML = highScore;

      //obstacle worker id

      //obstacleWorkerId = setInterval(obstackle,100);
...
// Create Obstacle 
f//unction createObstacle(){
    //var obstackle = document.createElement("div");
    //obstackle.className = "obstacle";
    
    //obstackleId = "obstacle" + obstackleId;

    //obstackleId++;

    //obstackleMarginLeft += gap;
    //background.appendChild(obstackle);
...
var tips = [
  ...
  "Avoid the Flames to survive!!",
  "You could have found a Money Belt at the end!"
];
